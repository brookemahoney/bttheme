 ...
 */
function bttheme_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['bttheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('bttheme sample setting'),
  '#default_value' => theme_get_setting('bttheme_example'),
